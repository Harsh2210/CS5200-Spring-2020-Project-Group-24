...
<form action="updateManager2.jsp" method="post">

<h1> Update information </h1>

	<input class="box" type="hidden" name="id" value="<%=rs.getString("id") %>">
	<br>
	<label style="color:white;font-family:'Courier New', Courier, monospace;">First name</label> 
	<input class="box" type="text" name="first_name" value="<%=rs.getString("first_name") %>">
	<br>
	<label style="color:white;font-family:'Courier New', Courier, monospace;">Last name</label>
	<input class="box" type="text" name="last_name" value="<%=rs.getString("last_name") %>">
	<br>
	<label style="color:white;font-family:'Courier New', Courier, monospace;">User name</label> 
	<input class="box" type="text" name="username" value="<%=rs.getString("user_name") %>">
	<br>
	<label style="color:white;font-family:'Courier New', Courier, monospace;">Password</label>
	<input class="box" type="text" name="password" value="<%=rs.getString("password") %>">
	<br>
	...
	<input class="box" type="text" name="phone_number" value="<%=rs.getString("phone") %>">
	<br>
	<label style="color:white;font-family:'Courier New', Courier, monospace;">Date of Birth</label>
	<input class="box" type="text" name="dob" value="<%=rs.getDate("dob") %>">
	<br>
	<br>
    
<br><br>
<button class="button button5"  id="submitDetails" name="submitDetails">Submit</button> <br>
</form>
</div>
<%
}
