...
<body>
   ...
   stmt=conn.createStatement();
    String update ="update manager set first_name='"+firstName+"',last_name='"+lastName+"',user_name = '"+userName+"', password ='"+password+"',email='"+email+"',phone='"+phone+"', dob='"+dob+"' where id="+id;
    statement = conn.prepareStatement(update);
    int valid = statement.executeUpdate();
    if(valid > 0){
    	response.sendRedirect("ManageAllManager.jsp");
    }
    else{
