...
<tr>
    ...
    <td><button class="button button5" onclick="window.location.href = 'updateTicketAdmin1.jsp?id=<%=rs.getString("id")%>'" value="Add" id="addToTable;">update</button></td>
    <td><button class="button button5" onclick="window.location.href = 'deleteTicketAdmin1.jsp?id=<%=rs.getString("id")%>'" value="Add" id="addToTable;">delete</button></td>
