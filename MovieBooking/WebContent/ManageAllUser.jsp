...
<tr>
	...
	<td><%=rs.getString("dob") %></td>
   	...
   	<td><button class="button button5" onclick="window.location.href = 'updateUser1.jsp?id=<%=rs.getString("id")%>'" value="Add" id="addToTable;">update</button></td>
    <td><button class="button button5" onclick="window.location.href = 'deleteUser1.jsp?id=<%=rs.getString("id")%>'" value="Add" id="addToTable;">delete</button></td>
