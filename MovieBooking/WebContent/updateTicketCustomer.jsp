...
<form action="updateTicketCustomer2.jsp" method="post">
...
%>
    ...
    <select class="form-control" id="movietime" name="movietime">
...
%>
    ...
    <select class="form-control" name = "seat_no" id="seat_no">
...
%>
<button class="button button5" onclick="window.location.href='viewAllTicketsCustomer.jsp'" type="submit" id="admin">Back</button><br><br>
</div>
